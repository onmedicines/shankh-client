...
function Home() {
  ...
  return (
    <div className={`max-w-screen min-h-screen overflow-x-hidden bg-slate-400 flex flex-col ${isMenuVisible ? "max-h-screen" : ""} }`}>
      ...
      <main className={`relative bg-amber-200 flex-grow`}>
        {/* Nav menu */}
        <div className={`absolute z-10 w-full h-full bg-blue-400 transition-transform duration-300 flex flex-col justify-between p-4 ${isMenuVisible ? "transform translate-x-0" : "transform -translate-x-full"}`}>
